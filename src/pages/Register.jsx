...
const Register = () => {
  ...
  useEffect(() => {
    ...
    if (username) {
      ...
      if (!usernameValidation.isValid()) {
        errors.username = usernameValidation.getFirstError();
      }
    }
    ...
    if (password) {
      ...
      if (!passwordValidation.isValid()) {
        errors.password = passwordValidation.getFirstError();
      }
    }
  ...
  const handleSubmit = async (e) => {
    ...
    if (Object.keys(errors).length > 0) {
      ...
      setError(firstError);
      toast.showToast('error', 'Đăng ký thất bại', firstError);
      return;
    }
                      ...
                      <form onSubmit={handleSubmit}>
                        <div className="mb-3">
                          ...
                          <div className="input-group">
                            ...
                            <input 
                              type="text" 
                              className={`form-control border-start-0 bg-light ${validationErrors.username ? 'is-invalid' : ''}`}
                          ...
                          {validationErrors.username && (
                            <div className="invalid-feedback d-block small">{validationErrors.username}</div>
                          )}
                        </div>
                        <div className="mb-3">
