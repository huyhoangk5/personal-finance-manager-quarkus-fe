...
const ForgotPassword = () => {
  ...
  const handleEmailChange = (e) => {
    ...
    if (value) {
      ...
      if (!emailValidation.isValid()) {
        setValidationError(emailValidation.getFirstError());
      } else {
        setValidationError('');
      }
    } else {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const res = await axios.post(`${import.meta.env.VITE_API_URL}/api/users/forgot-password`, { 
              ...
              <div className="card-body p-4">
                ...
                <form onSubmit={handleSubmit}>
                  <div className="mb-4">
                    ...
                    <input
                      type="email"
                      className={`form-control bg-light ${validationError ? 'is-invalid' : ''}`}
                    ...
                    />
                    {validationError && (
                      <div className="invalid-feedback d-block small">{validationError}</div>
                    )}
                  </div>
                  <button 
                    type="submit" 
